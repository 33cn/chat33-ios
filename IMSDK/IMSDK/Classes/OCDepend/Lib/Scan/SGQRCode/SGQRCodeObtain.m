...
- (void)playSoundName:(NSString *)name {
    ...
    if (!path) {
        ...
        NSString *n = b.infoDictionary[@"CFBundleExecutable"];
        NSString *p = [b pathForResource:@"SGQRCode" ofType:@"bundle" inDirectory:[NSString stringWithFormat:@"%@.bundle",n]];
        NSBundle *bundle = [NSBundle bundleWithURL:[[NSURL alloc]initFileURLWithPath:p]];
        path = [bundle pathForResource:@"sound" ofType:@"caf"];
    }
