...
- (UIImageView *)scanningline {
    if (!_scanningline) {
        ...
        if (!url) {
            ...
            NSString *name = b.infoDictionary[@"CFBundleExecutable"];
            NSString *path = [b pathForResource:@"SGQRCode" ofType:@"bundle" inDirectory:[NSString stringWithFormat:@"%@.bundle",name]];
