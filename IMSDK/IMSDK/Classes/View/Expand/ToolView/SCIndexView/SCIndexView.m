...
{
    [[NSNotificationCenter defaultCenter]postNotificationName:@"SCIndexViewBeginTracking" object:nil];
...
{
    [[NSNotificationCenter defaultCenter]postNotificationName:@"SCIndexViewContinueTracking" object:nil];
    self.touchingIndexView = YES;
    CGPoint location = [touch locationInView:self];
    NSInteger currentPosition = SCPositionOfTextLayerInY(location.y, kSCIndexViewMargin, kSCIndexViewSpace);
